CREATE OR REPLACE PACKAGE BODY HOTEL IS
    ...
    BEGIN
        ...
        LOOP
            IF(NOT(RESERVATION.START_DATE >= ARG_END_DATE AND ARG_START_DATE >= RESERVATION.END_DATE)) THEN
                RETURN FALSE;
            END IF;
        END LOOP;
        RETURN TRUE;
    ...
    BEGIN
        ...
        YEARS_PASSED := FLOOR(MONTHS_BETWEEN(SYSDATE, CLIENT_DOJ));
